            ...
            <div class="col-xl-6 col-md-6">
                <div class="action-item">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input charge" type="radio" value="0" name="charge" id="flexRadioDefault2" checked>
                            <label class="form-check-label" for="flexRadioDefault2">
                                Free shipping
                            </label>
                          </div>
                        <div class="form-check">
                            <input class="form-check-input charge" type="radio" name="charge" value="100" id="flexRadioDefault1">
                ...
                <div class="action-item m-0">
                    <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="payment_method" value="2" id="c2" data-bs-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample" @error('tran_number') checked @enderror @error('tran_id') checked @enderror>
                                <label class="form-check-label" for="c2">bKash payment</label>
                                <div class="collapse  @error('tran_number') show @enderror @error('tran_id') show @enderror" id="collapseExample">
