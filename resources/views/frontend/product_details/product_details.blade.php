                ...
                <div class="col-xl-12">
                    <div class="product-area details-product-area mb--70 justify-content-center">
                        ...
                        <div class="contents">
                            ...
                            <h2 class="product-title">{{$details->first()->product_name}} <span class="stock">In Stock</span></h2>
                                ...
                                @foreach ($available_colors as $color)
                                    @if ($color->rel_to_color->color_code == null)
                                        <div class="form-check form-option form-check-inline mb-1">
                                            ...
                                            <label class="form-option-label rounded-circle" style="background: {{ $color->rel_to_color->color_name }}" for="color{{ $color->rel_to_color->id }}">
                            ...
                            <div class="action-item3">
                                ...
                                <div class="text-left pb-0 pt-2" id="size_id">
                                    ...
                                    <div class="form-check size-option form-option form-check-inline mb-2">
                                        ...
                                        <label class="form-option-label" for="size{{$size->id}}">{{$size->rel_to_size->size_name}}</label>
                                    </div>
                                    @else
                                    <div class="form-check size-option form-option form-check-inline mb-2">
                                        <input class="form-check-input" value="{{$size->rel_to_size->id}}" type="radio" name="size_id" id="size{{$size->id}}">
